...
namespace NeuralNetworkTests.Library
{
    ...
    public class NodeGroupCalculationsTest
    {
        ...
        {
            // Input group
            var inputGroup = new NodeLayer("Input Group", 10);
        ...
        public void TestBasicNetworkResult()
        {
            ...
            var inner = new NodeLayer("Inner 1", nodesInner, new[] { inputGroup });
            // Output group
        ...
        public void TestMultipleGroup()
        {
            ...
            var inner1 = new NodeLayer("Inner 1", nodesInner1, new[] { inputGroup });

            // Hidden group 2
            var nodesInner2 = new[] { new Node { Weights = new[] { new[] { 0.2 } }, BiasWeights = new[] { 0.7 } } };
            var inner2 = new NodeLayer("Inner 2", nodesInner2, new[] { inputGroup });
        ...
        {
            var inputGroup = new NodeLayer("Input Group", 2);
            var nodesInner = new[] {
            ...
            var output = new NodeLayer("Inner 1", nodesOutput, new[] { inner });
