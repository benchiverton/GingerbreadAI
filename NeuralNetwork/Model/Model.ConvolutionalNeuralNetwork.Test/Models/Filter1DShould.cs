...
namespace Model.ConvolutionalNeuralNetwork.Test.Models
{
    public class Filter1DShould
    {
        ...
        public void ResolveCorrectNodeReferences()
        {
            ...
            // X  X  X  O  O  O
            var input1 = new Layer1D(6, new Layer[0], ActivationFunctionType.RELU, InitialisationFunctionType.Uniform);
            var input2 = new Layer1D(6, new Layer[0], ActivationFunctionType.RELU, InitialisationFunctionType.Uniform);
            var input3 = new Layer1D(6, new Layer[0], ActivationFunctionType.RELU, InitialisationFunctionType.Uniform);

            var filter = new Filter1D(new[] { input1, input2, input3 }, 3, ActivationFunctionType.RELU, InitialisationFunctionType.Uniform);
