...
namespace DeepLearning.NegativeSampling.Test
{
    public class NegativeSamplingShould
    {
        ...
        {
            var input = new Layer(100, new Layer[0]);
            var h1 = new Layer(50, new Layer[] { input });
            var output = new Layer(100, new Layer[] { h1 });
        ...
        {
            var input = new Layer(10, new Layer[0]);
            var h1 = new Layer(10, new Layer[] { input });
            var h2 = new Layer(10, new Layer[] { h1 });
            var h3 = new Layer(10, new Layer[] { h1 });
            var h4 = new Layer(10, new Layer[] { h2, h3 });
            var output = new Layer(10, new Layer[] { h4 });
